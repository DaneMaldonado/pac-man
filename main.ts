...
info.setScore(0)
let TotalScoreNeeded = [40, 60, 80]
let LevelScoreNeeded = 0
Difficulty = game.askForNumber("Choose your difficulty: 0 to 2.", 1)
WinScore = TotalScoreNeeded[Difficulty]
FalseDifficultyInput()
Duck.sayText(WinScore)
...
forever(function () {
    console.log("How can I use an array in my \"LevelDifficulty\" function?")
    console.log("Game over is not working.")
})
game.onUpdateInterval(2150, function () {
    if (true) {
        ...
        TopImage.top = -20
        TopImage.setFlag(SpriteFlag.AutoDestroy, true)
        BottomImage.setFlag(SpriteFlag.AutoDestroy, true)
        TopImage.vx = -25
        BottomImage.vx = -25
    }
